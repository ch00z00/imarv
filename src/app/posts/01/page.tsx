    ...
    <>
      ...
      <div className="bg-black-200 text-white-200 flex flex-col tracking-wider space-y-32 h-fit px-[min(14vw)] py-[min(10vw)]">
        <div className="grid grid-cols-2">
          ...
          <div className="text-[min(1.5vw,20px)] font-zen-old-mincho">銃器強奪事件の面通しで集められた5人の前科者たち(“The Usual Suspects”=「常連の容疑者」)。そのうちの一人、詐欺師キント（ケヴィン・スペイシー）は、「悪魔が世界に信じさせた最大のトリックは、自分が存在しないということだ」と述べた…。彼は、史上最も謎に包まれた伝説的な犯罪者であるカイザー・ソゼが実在することをエピソードトークで捜査官に説得しようとする。歯車の狂い始めた犯罪計画を卓越した構成で描いたサスペンス・ミステリー作品！</div>
        </div>
